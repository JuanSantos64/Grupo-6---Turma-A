...
2) Os senhores A, B e C concorriam à liderança de certo partido político. Para escolher o líder, cada eleitor votou apenas em dois candidatos de sua preferência. Houve 100 votos para A e B, 80 votos para B e C e 20 votos para A e C. Em consequência:
...
4) Dado o conjunto A = {1,2,5, 10, 15, 28}, o número de subconjuntos possíveis para esse conjunto é:
...
5) Dado o conjunto U = números naturais de 0 até 20. Sabendo que B = números múltiplos de 3, podemos afirmar que o conjunto Bc (complementar de B) é igual ao conjunto:
...
6) Sobre os conjuntos numéricos, marque a alternativa incorreta.
...
7) Em uma escola, 300 alunos foram entrevistados sobre as práticas esportivas. Os estudantes foram questionados sobre a prática de exercícios fora da escola. Com esse questionário, foi possível dividir os estudantes em grupos:
...
8) Seja A = {2,5}, B = {2,5,6} e C = {6,10}, determine os elementos da operação (A U B) ∩ (B U C).
...
9) Sobre os conjuntos numéricos, julgue as afirmativas a seguir.
...
1) O valor de x que faz a equação 2x+1=32
  é:
...
4) O conjunto de soluções da equação exponencial 3⋅2x2−4=48
  é:
...
5) O montante de determinado capital em um fundo de investimento, após o tempo t em anos, é dado pela fórmula M(t)=C⋅1,5t
...
6) A quantidade de bactérias de uma cultura, depois de t horas, é dada pela expressão Q(t)=Q0⋅2t
...
7) Durante um experimento, obteve-se a fórmula para a população de bactérias:
...
8) Sabendo que x=(15)(2t+1)
 e y=(0,2)3t − 2 
, o valor de y que faz com que x seja igual a y é:
...
9) Dada a equação exponencial 3x2−x=9
...
1) As raízes da equação 2x2 + bx + c = 0 são 3 e − 4. Nesse caso, o valor de b - c é
a) −26.
b) −22.
c) −1.
d) 22.
...
2) Uma função quadrática f é dada por f(x) = x2 + bx + c, com b e c reais. Se f(1) = –1 e f(2) – f(3) = 1, o menor valor que f(x) pode assumir, quando x varia no conjunto dos números reais, é igual a
...
3) Observe a função f, definida por:
...
4) A água é essencial para a vida e está presente na constituição de todos os alimentos. Em regiões com escassez de água, é comum a utilização de cisternas para a captação e armazenamento da água da chuva. Ao esvaziar um tanque contendo água da chuva, a expressão
...
5)Quais são as raízes reais da equação x2 – x = 6?
...
6) Um terreno quadrado possui área de 144 metros quadrados e apenas a sua frente ainda não está murada. Quantos metros de muro terão que ser feitos para isolar completamente esse terreno?
...
7) A temperatura T de um forno (em graus centígrados) é reduzida por um sistema a partir do instante do desligamento (t = 0) e varia de acordo com a expressão (t em minutos):
...
8) Qual é a medida de um ângulo interno de um polígono convexo que possui 230 diagonais?
...
9) Sejam x1 e x2 as raízes da equação x2 + 8x + 7. Qual é o valor de x1·x2?
...
10) Qual é a maior das raízes da equação do segundo grau – x2 – 12x – 35?
