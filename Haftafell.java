...
"\n" +
"Cena 1 - Explorar a Praça Central: Ao caminhar pela praça, você observa um grupo de crianças brincando com pedras brilhantes desenhadas com símbolos matemáticos. Intrigado, você se aproxima e pergunta sobre a Matemática Divina. Uma das crianças menciona um lago perto da cidade que costuma frequentar, diz a pegou de lá…\n" +
"\n" +
"Perguntar a localização do lago.\n" +
"\n" +
"Cena 2 - Conversar com os Habitantes Locais: Você decide se aproximar de um grupo de habitantes locais em uma taverna. Ao mencionar a Matemática Divina, um ancião menciona uma antiga ruína nos arredores de Midland, conhecida por esconder segredos mágicos.\n" +
"\n" +
"Partir para a Ruína.\n" +
"\n" +
"Perguntar por mais detalhes na Taverna.\n" +
"\n" +
"Escolha seu caminho digitando o número correspondente.\n" +
"Escolha com sabedoria, pois suas decisões moldarão a narrativa e o destino de Haftafell.");
        int escolha = entrada.nextInt();
        switch(escolha){
            case 1 -> System.out.println("Cena 1: ");
            case 2 -> System.out.println("Cena 2: ");
            default -> {
...
>>>>>>> 2cb63011c38a4a436ddcf1291a2c6c0ff6b7df76
